...
/*
 * This file is part of husseinsayed/charts.
 *
...
class Chart
{
    ...
    public function render()
    {
        ...
        if (file_exists($file)) {
            ...
            $img_url = file_exists(public_path().'/vendor/husseinsayed/charts/error.png') ? asset('/vendor/husseinsayed/charts/error.png') : 'http://www.iconsfind.com/wp-content/uploads/2015/12/20151208_56663ed552e5d.png';
